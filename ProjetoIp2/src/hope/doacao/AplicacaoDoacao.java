...
public class AplicacaoDoacao {
	...
	public static void main(String[] args) {
		...
		System.out.println("**** DOAÃ‡Ã•ES **** \n");
		
		do {
			
			System.out.println("Escolha a opÃ§Ã£o desejada: \n 1- Cadastrar doaÃ§Ã£o \n 2- Pesquisar doaÃ§Ã£o\n 3- Alterar doaÃ§Ã£o\n 4- Excluir doaÃ§Ã£o\n 5- Listar doaÃ§Ãµes\n 6- SAIR\n ");
			...
			switch(option) {
				case 1:
					System.out.println("Informe o seu CPF/CNPJ: \n");
				  	String id = leitura.nextLine();
				  		do{
				  		System.out.println(" Digite uma identificaÃ§Ã£o vÃ¡lida: \n");
				  		id = leitura.nextLine();
				  		} while (id == null);
				  		...
				  		System.out.println("Informe o codigo da InstituiÃ§Ã£o que serÃ¡ beneficiada: \n");
					  	String codInstituicao = leitura.nextLine();
					  	while (codInstituicao == null) {
					  		System.out.println("Informe uma identificaÃ§Ã£o vÃ¡lida: \n");
					  		codInstituicao = leitura.nextLine();
					  	}
				  	
					  	System.out.println("Informe a quantidade de doaÃ§Ãµes que vocÃª farÃ¡ hoje: ");
					  	int quantidade = leitura.nextInt();
					  	leitura.nextLine();
					  	
					  	
					  	//System.out.println("Informe os produtos que fazem parte desta doaÃ§Ã£o: \n");
					  	
					  	
					  	System.out.println("Informe a quantia em dinheiro a ser doada: \n");
					  	int doacaoDinheiro = leitura.nextInt();
					  	
					  	System.out.println("Informe um cÃ³digo para esta doaÃ§Ã£o: \n");
				...
				case 2:
					  	...
					  	System.out.println("Informe o codigo da doaÃ§Ã£o que vocÃª deseja pesquisar: \n");
					  	cod = leitura.nextInt();
					  	leitura.nextLine();
				...
				case 3:
						...
						System.out.println("Informe o codigo da doaÃ§Ã£o a ser alterada: \n");
						cod = leitura.nextInt();
						leitura.nextLine();
						...
						System.out.println("Informe a nova quantidade de doaÃ§Ãµes: ");
				...
				case 4:
						...
						System.out.println("Informe o cÃ³digo da doaÃ§Ã£o que vocÃª deseja remover: ");
						cod = leitura.nextInt();
				...
				default:
						...
						System.out.println("VocÃª escolheu uma opÃ§Ã£o invÃ¡lida!");
			}
